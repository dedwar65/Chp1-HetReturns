...
%\vspace{10mm}
%Key finding: The life-cycle model with different returns for households matches data well in terms of targeted and untargeted wealth moments.
\end{frame}
%%%%%%%%%%%%%%%%%%
...
%\item Exploring possible explanations for the persistent component of return het. 
%\end{enumerate}
%\end{frame}
%%%%%%%%%%%%%%%%%%
